...
* Robust statistical distances for mixed-type multivariate data ([Grané &amp; Scielzo-Ortiz, 2025, SORT]({{ "/publications/" | relative_url }})), implemented in the Python package [`robust-mixed-dist`](https://github.com/FabioScielzoOrtiz).
* New distance-based robust clustering algorithms for large mixed-type data ([Grané &amp; Scielzo-Ortiz, 2026, Advances in Data Analysis and Classification]({{ "/publications/" | relative_url }})), implemented in the Python package [`db-robust-clust`](https://github.com/FabioScielzoOrtiz).
...
More about my publications, talks and teaching can be found on the [CV]({{ "/cv/" | relative_url }}), [Publications]({{ "/publications/" | relative_url }}) and [Talks]({{ "/talks/" | relative_url }}) pages.

Get in touch
======
Feel free to reach out at [fabio.scielzoortiz@gmail.com](mailto:fabio.scielzoortiz@gmail.com) — I am always happy to discuss statistics, machine learning, or potential collaborations.
